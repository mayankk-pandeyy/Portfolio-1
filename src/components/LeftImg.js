...
function LeftImg(){
    return (
        <div>
           <div className="ml-[250px] text-end font-poppins">
            ...
            <div className="flex items-center w-full justify-end">
                ...
                <div className="relative z-30">
                    ...
                    <div className="w-[380px] h-[230px] bg-orange-500 absolute -top-3 -left-3 -z-20 rounded-l-2xl"></div>
                </div>
                ...
                <div className="relative z-40">
                    ...
                    <div className="text-white pt-8 text-2xl flex gap-3 justify-end">
